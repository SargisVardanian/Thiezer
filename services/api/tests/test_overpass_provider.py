...
@pytest.mark.asyncio
async def test_overpass_provider_does_not_generate_observation_places() -> None:
    def handler(_: httpx.Request) -> httpx.Response:
        raise AssertionError("surface discovery must not call the store Overpass adapter")
